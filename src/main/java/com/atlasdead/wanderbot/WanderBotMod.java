...
public class WanderBotMod {
    ...
    public static final String VERSION = "1.11.0-search-patrol";

    public static final KeyBinding TOGGLE_KEY = new KeyBinding("KeyBindMod Toggle", Keyboard.KEY_K, "KeyBindMod");
    public static final KeyBinding CLICKGUI_KEY = new KeyBinding("KeyBindMod ClickGUI", Keyboard.KEY_RSHIFT, "KeyBindMod");
