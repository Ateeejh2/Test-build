...
public class MovementController {
    ...
    /**
     * Performs an actual Minecraft 1.8.9 left-click action. Merely setting the
     * attack KeyBinding state is not sufficient for the client click pipeline
     * because the normal mouse event also drives Minecraft.clickMouse().
     */
