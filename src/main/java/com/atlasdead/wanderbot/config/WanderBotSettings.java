...
public final class WanderBotSettings {
    ...
    public static double targetScanRange = 18.0D;
    ...
    public static void load(File configDir) {
        ...
        targetScanRange = config.getFloat("targetScanRange", "combat", (float) targetScanRange, 8.0F, 32.0F, "Target scan range.");
    ...
    public static void save() {
        ...
        config.getCategory("render").setProperty("showPath", Boolean.toString(showPath));
        config.getCategory("render").setProperty("showTarget", Boolean.toString(showTarget));
        config.getCategory("render").setProperty("showTargetGuide", Boolean.toString(showTargetGuide));
        config.getCategory("render").setProperty("showHud", Boolean.toString(showHud));
        config.getCategory("render").setProperty("debugDashboard", Boolean.toString(debugDashboard));
        config.getCategory("bot").setProperty("combatEnabled", Boolean.toString(combatEnabled));
        config.getCategory("bot").setProperty("navigationEnabled", Boolean.toString(navigationEnabled));
        config.getCategory("bot").setProperty("megastreakStrategy", Boolean.toString(megastreakStrategy));
